...
def test_operations_to_list_of_dicts():
    assert operations_to_list_of_dicts("1") == []
    assert operations_to_list_of_dicts("") == []
    assert operations_to_list_of_dicts("./data/operations.json") == []
    assert operations_to_list_of_dicts("../data/operations.json") == [
        {
            "id": 441945886,
            "state": "EXECUTED",
